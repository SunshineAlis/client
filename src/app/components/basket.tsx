...
import QuantityControl from "@/OrderCompenent/QuantityControl";
...
const Basket: React.FC<BasketProps> = ({
    ...
    return (
        <div
            className={`fixed top-0 right-0 h-full bg-white shadow-lg p-6 transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
                } w-80`}
        >
            <button
            ...
            {orderedFoods.length > 0 && (
                <div className="flex justify-end mt-4">
                    ...
                    {/* 🆕 SubmitOrder компонентыг ашиглах */}
                    <SubmitOrder
