<div
    key={food._id}
    className="relative border border-gray-300 shadow-lg flex flex-col justify-center items-center rounded-xl bg-white p-4 transition-transform hover:scale-105"
>
    {food.image && (
        <img
    ...
    <button
        className="absolute top-[30%] right-[15%] w-10 h-10 rounded-full bg-white  text-2xl text-black font-semibold rounded-lg transition-colors hover:bg-red-600"
